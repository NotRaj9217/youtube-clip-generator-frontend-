...
document.addEventListener('DOMContentLoaded', () => {
    // Navigation
    // UPDATED: 'nav-tab' instead of 'nav-btn' matches style.css and new index.html
    ...
    navButtons.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            sections.forEach(s => {
                ...
                // Optional: add a small delay for fade-out if needed, but simple toggle is safer
            });
            ...
            // Load data if needed
            if (targetId === 'downloads-section') loadDownloads();
